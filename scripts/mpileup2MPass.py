...
def main():
    ...
    parser.add_argument('-m','--mpileupfile',help = 'mpileup file')
    parser.add_argument('-n','--numbermap',help = 'number map')
    parser.add_argument('-d','--design',help = 'design')
    parser.add_argument('-c','--cov_depth',help = 'cov_depth')
    parser.add_argument('-o','--MPassfile',help = 'MPass file')
    args=parser.parse_args()
    mpileupfile=args.mpileupfile
    numbermap=int(args.numbermap)
    design=int(args.design)
    cov_depth=int(args.cov_depth)
    MPassfile=args.MPassfile
    
    
    mpileup=pd.read_table(mpileupfile, header=None)
    count_table=
