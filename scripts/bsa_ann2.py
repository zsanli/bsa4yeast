...
def main():
    ...
    t6['P1_SNAP']='NA';t6['P2_SNAP']='NA'
    for i in range(len(t6)):
        gene_id=t6['gene_id_P1'][i].split(';')
        if t6['P1_variant_type'][i]=='nonsynonymous SNV':
            if len(gene_id)==1 :
                t6['P1_SNAP'][i]=SNAP_score[SNAP_score['GENE']==gene_id[0]][SNAP_score['AACHANGE']==t6['protein_P1'][i]]['SNAPSCORE'].astype(str).values[0]
            else:
                tmp_score=[]
...
#                    print SNAP_score[SNAP_score['GENE']==gene_id[iii]][SNAP_score['AACHANGE']==t6['protein_P1'][i].split(';')[iii]]['SNAPSCORE']
                    if SNAP_score[SNAP_score['GENE']==gene_id[iii]][SNAP_score['AACHANGE']==t6['protein_P1'][i].split(';')[iii]]['SNAPSCORE'].values:
                        tmp_score.append(SNAP_score[SNAP_score['GENE']==gene_id[iii]][SNAP_score['AACHANGE']==t6['protein_P1'][i].split(';')[iii]]['SNAPSCORE'].astype(str).values[0])
                    else:
                        tmp_score.append('NA')
#                print tmp_score
                t6['P1_SNAP'][i]=';'.join(tmp_score)
                
    for i in range(len(t6)):
        gene_id=t6['gene_id_P2'][i].split(';')
...
#                    print SNAP_score[SNAP_score['GENE']==gene_id[iii]][SNAP_score['AACHANGE']==t6['protein_P2'][i].split(';')[iii]]['SNAPSCORE']
                    if SNAP_score[SNAP_score['GENE']==gene_id[iii]][SNAP_score['AACHANGE']==t6['protein_P2'][i].split(';')[iii]]['SNAPSCORE'].values:
                        tmp_score.append(SNAP_score[SNAP_score['GENE']==gene_id[iii]][SNAP_score['AACHANGE']==t6['protein_P2'][i].split(';')[iii]]['SNAPSCORE'].astype(str).values[0])
                    else:
                        tmp_score.append('NA')
#                print tmp_score
                t6['P2_SNAP'][i]=';'.join(tmp_score)    
    
    t6['P1_SNAP']=t6['P1_SNAP'].replace('NA','-')
    t6['P2_SNAP']=t6['P2_SNAP'].replace('NA','-')
    t6['P1_SNAP']=t6['P1_SNAP'].replace('nan','-')
    t6['P2_SNAP']=t6['P2_SNAP'].replace('nan','-')
